...
/* Calculate the value required in the speed register for the correct frequency.
 */
...
struct spi_dev_s *bcm2711_spibus_initialize(int port) { return NULL; }

#endif /* defined(CONFIG_BCM2711_SPI) */
